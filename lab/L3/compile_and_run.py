...
# Run GCC command
gcc_command = ["gcc", "scanner.c", "SymbolTableCONSTS.c", "SymbolTableIDS.c", "-o", "scanner.exe"]
...
# Run scanner.exe with the input file as an argument
scanner_command = ["./scanner.exe", input_file]
