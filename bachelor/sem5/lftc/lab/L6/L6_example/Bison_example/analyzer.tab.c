...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "CINOPP", "CIN", "$accept", "program", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: CIN CINOPP ID SEMICOLON  */
#line 22 "analyzer.y"
                {
			printf("mov eax, str_a \n call io_writestr \n call io_readint \n mov ebx, eax \n");
		}
#line 1071 "analyzer.tab.c"
    break;


#line 1075 "analyzer.tab.c"
